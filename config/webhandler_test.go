			...
			Scenes: []AudioSceneConfig{
				{
					...
					Segments: []AudioSegmentConfig{
						{StartLed: 0, EndLed: 1, Effect: AudioEffectLeftVU},
						{StartLed: 2, EndLed: 3, Effect: AudioEffectRightVU},
					},
				},
			},
			VU: AudioVUConfig{
				LedLow:        []float64{0, 0, 0},
				LedMid:        []float64{0, 0, 0},
				LedHigh:       []float64{0, 0, 0},
				SwitchSteps:   []int{60, 80},
				PeakHoldTime:  250 * time.Millisecond,
				PeakDecayRate: 15.0,
			},
			Spectrum: AudioSpectrumConfig{
				LedLow:  []float64{0, 0, 0},
				LedMid:  []float64{0, 0, 0},
				LedHigh: []float64{0, 0, 0},
			},
